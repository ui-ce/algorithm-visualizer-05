...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g4 = $(), it = k(), lt = h(), L, N2, ot = "top";
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, f2 = te || {}, { colorScheme: K2 } = f2, A2 = v2(f2, ["colorScheme"]), x3 = re || {}, { colorScheme: X } = x3, G2 = v2(x3, ["colorScheme"]), p3 = K2 || {}, { dark: U2 } = p3, B3 = v2(p3, ["dark"]), y3 = X || {}, { dark: I2 } = y3, H2 = v2(y3, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s2(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s2(B3) ? this._toVariables({ light: B3 }, n) : {}, pe = s2(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s2(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s2(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s2(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R3 = W2.declarations) != null ? R3 : "", W2.tokens], [Ke, Xe] = [(T3 = q2.declarations) != null ? T3 : "", q2.tokens || []], [Ge, Ue] = [(j3 = Z.declarations) != null ? j3 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M2 = fe.declarations) != null ? M2 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R3, extend: T3, css: j3 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T3 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R3 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), h2 = M2 || {}, { dark: te } = h2, re = v2(h2, ["dark"]), K2 = s2(O2) ? this._toVariables({ [y3]: g3(g3({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: g3(g3({}, L), re) }, r) : {}, X = s2(V2) ? this._toVariables({ [y3]: g3(g3({}, V2), te) }, r) : {}, [G2, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B3, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H2, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y3, `${G2}${B3}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I2, ...W2])], c2 = m(j3, { dt: E2 });
  }
...
//# sourceMappingURL=chunk-AZUY7LQO.js.map
