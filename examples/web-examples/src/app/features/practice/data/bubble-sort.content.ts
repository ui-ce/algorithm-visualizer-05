...
export const BUBBLE_SORT_CONTENT: AlgorithmContent = {
  ...
  applications: [
    'Teaching the fundamentals of comparison-based sorting and algorithm analysis.',
    'Sorting very small datasets where implementation simplicity matters more than raw speed.',
    'Detecting whether a dataset is already sorted or nearly sorted, using the early-exit variant as a cheap check.',
    'Environments with extremely limited code size or memory, where a minimal sorting routine is preferable to a more complex one.',
    'As a building block for explaining more advanced sorts (Insertion Sort, Cocktail Sort, Selection Sort) by contrast.',
  ],
  implementations: [
    {
      language: 'Python',
