 ...
 *
 * @usage
 * `<svg solarSnowflakeBold [size]="24" color="#ef4444" />`
 */
export declare class SolarSnowflakeBold extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarSnowflakeBold, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarSnowflakeBold, "svg[solarSnowflakeBold]", never, {}, {}, never, never, true, never>;
}
