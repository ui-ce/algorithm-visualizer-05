 ...
 *
 * @usage
 * `<svg solarMedalRibbonsStarBoldDuotone [size]="24" color="#ef4444" />`
 */
export declare class SolarMedalRibbonsStarBoldDuotone extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarMedalRibbonsStarBoldDuotone, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarMedalRibbonsStarBoldDuotone, "svg[solarMedalRibbonsStarBoldDuotone]", never, {}, {}, never, never, true, never>;
}
