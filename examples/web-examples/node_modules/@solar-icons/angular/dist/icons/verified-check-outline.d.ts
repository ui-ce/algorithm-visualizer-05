 ...
 *
 * @usage
 * `<svg solarVerifiedCheckOutline [size]="24" color="#ef4444" />`
 */
export declare class SolarVerifiedCheckOutline extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarVerifiedCheckOutline, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarVerifiedCheckOutline, "svg[solarVerifiedCheckOutline]", never, {}, {}, never, never, true, never>;
}
