 ...
 *
 * @usage
 * `<svg solarMusicLibrary2Outline [size]="24" color="#ef4444" />`
 */
export declare class SolarMusicLibrary2Outline extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarMusicLibrary2Outline, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarMusicLibrary2Outline, "svg[solarMusicLibrary2Outline]", never, {}, {}, never, never, true, never>;
}
