 ...
 *
 * @usage
 * `<svg solarCallChatOutline [size]="24" color="#ef4444" />`
 */
export declare class SolarCallChatOutline extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarCallChatOutline, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarCallChatOutline, "svg[solarCallChatOutline]", never, {}, {}, never, never, true, never>;
}
