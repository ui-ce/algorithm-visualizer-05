 ...
 *
 * @usage
 * `<svg solarFileOutline [size]="24" color="#ef4444" />`
 */
export declare class SolarFileOutline extends IconBase {
    static ɵfac: i0.ɵɵFactoryDeclaration<SolarFileOutline, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SolarFileOutline, "svg[solarFileOutline]", never, {}, {}, never, never, true, never>;
}
