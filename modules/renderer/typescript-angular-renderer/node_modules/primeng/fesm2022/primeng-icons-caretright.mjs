...
class CaretRightIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: CaretRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: CaretRightIcon, isStandalone: true, selector: "[data-p-icon=\"caret-right\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: CaretRightIcon, decorators: [{
            type: Component,
            args: [{
